...
export function readSettingsFromDom(documentRef = document) {
  return {
    ...
    fontFamily: documentRef.getElementById("fontFamily").value,
    fontSize: Number(documentRef.getElementById("fontSize").value) || DEFAULT_SETTINGS.fontSize,
    fontWeight: documentRef.getElementById("fontWeight").value,
    fontStyle: documentRef.getElementById("fontStyle").value,
    fillColor: documentRef.getElementById("fillColor").value,
    strokeColor: documentRef.getElementById("strokeColor").value,
    strokeWidth: Number(documentRef.getElementById("strokeWidth").value) || 0,
    backgroundColor: documentRef.getElementById("backgroundColor").value,
    enableDefaultBackground: documentRef.getElementById("enableDefaultBackground").checked,
    placement: documentRef.getElementById("placement").value,
